...
A partir de um dataset sintético (ou real), são descobertos padrões de compra que ajudam a entender quais produtos tendem a ser adquiridos juntos, apoiando estratégias de marketing, vendas cruzadas e organização de prateleiras.
